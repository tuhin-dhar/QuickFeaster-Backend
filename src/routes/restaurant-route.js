...
router.get("/search/:city", (0, express_validator_1.param)("city")
    ...
    .trim()
    .notEmpty()
    .withMessage("City parameter is required"), restaurantController.searchRestaurants);
router.get("/all", restaurantController.getRestaurants);
router.get("/:restaurantId", (0, express_validator_1.param)("restaurantId")
    .notEmpty()
    .isString()
    .trim()
    .withMessage("Restraurant Id parameter is required"), restaurantController.getRestaurant);
